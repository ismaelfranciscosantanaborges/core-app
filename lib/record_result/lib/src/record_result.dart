...
/// }
/// ```
typedef RecordResult<T> = ({T? success, Failure? failure});
...
/// });
/// ```
typedef FutureRecordResult<T> = Future<RecordResult<T>>;
...
/// }
/// ```
typedef StreamResult<T> = Stream<RecordResult<T>>;
...
/// }
/// ```
typedef RecordResultVoid = RecordResult<void>;
...
/// });
/// ```
typedef FutureRecordResultVoid = Future<RecordResultVoid>;
...
/// }
/// ```
typedef StreamRecordResultVoid = Stream<RecordResultVoid>;
...
/// Result<int> result = right(42);
/// ```
RecordResult<T> right<T>(T param) => (success: param, failure: null);
...
extension Fold<T> on RecordResult<T> {
  ...
  B fold<B>(
    ...
    return ifFailure(failure ?? ServerFailure(statusCode: 409));
  }
